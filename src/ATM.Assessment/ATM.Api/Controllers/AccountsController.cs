...
namespace ATM.Web.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Transfer([FromBody] TransferRequest request)
        {
            ...
            var (source, destination) = await _accountService.TransferAsync(request.SourceAccountId, request.DestinationAccountId, request.Amount);
            if (source == null || destination == null) return BadRequest("Transfer failed");
